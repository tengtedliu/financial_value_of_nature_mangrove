...
# my_palette <- c("#8A9A5B", "gray95")  # Replace with your preferred color palette function and number of colors
...
f1_50_mang<- 
  ...
  geom_ribbon(
    ...
    fill = "red",
    alpha = 0.3)+
  xlab("Price Change (%) After Hurricane Sandy - Mangrove Effect") + ylab(" ")+
  theme(axis.title.x = element_text(hjust = 0.5),  # Center x-axis label
