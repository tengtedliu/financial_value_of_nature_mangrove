...
f1_50 <- 
  ...
  annotate("text", x = -170, y = 0.9, label = paste0("pVaR=", round((cdf_value_7n) * 100, 0), "%"),
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # annotate("richtext", 
  #          x = -170, y = 0.9, 
  #          label = paste0("<span style='color:red;'>VaR</span>=", round((cdf_value_1n) * 100, 0), "ppt"), 
  #          vjust = 1, hjust = 0, size = 4, 
  #          fill = NA, label.color = NA) +
  # Miami (Previously at y = 5.9, now at 1.9)
  annotate("text", x = -170, y = 1.9, label = paste0("pVaR=", round((cdf_value_6n) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Manatee (Previously at y = 4.9, now at 2.9)
  annotate("text", x = -170, y = 2.9, label = paste0("pVaR=", round((cdf_value_5n) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Lee (Previously at y = 3.9, now at 3.9)
  annotate("text", x = -170, y = 3.9, label = paste0("pVaR=", round((cdf_value_4n) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Hillsborough (Previously at y = 2.9, now at 4.9)
  annotate("text", x = -170, y = 4.9, label = paste0("pVaR=", round((cdf_value_3n) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Collier (Previously at y = 1.9, now at 5.9)
  annotate("text", x = -170, y = 5.9, label = paste0("pVaR=", round((cdf_value_2n) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Charlotte (Previously at y = 0.9, now at 6.9)
  annotate("text", x = -170, y = 6.9, label = paste0("pVaR=", round((cdf_value_1n) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black")
...
f1_50_ivan <- 
  ...
  # Pinellas (Previously at y = 6.9, now at 0.9)
  annotate("text", x = -170, y = 0.9, label = paste0("pVaR=", round((cdf_value_7n_ivan) * 100, 0), "%"),
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Miami (Previously at y = 5.9, now at 1.9)
  annotate("text", x = -170, y = 1.9, label = paste0("pVaR=", round((cdf_value_6n_ivan) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Manatee (Previously at y = 4.9, now at 2.9)
  annotate("text", x = -170, y = 2.9, label = paste0("pVaR=", round((cdf_value_5n_ivan) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Lee (Previously at y = 3.9, now at 3.9)
  annotate("text", x = -170, y = 3.9, label = paste0("pVaR=", round((cdf_value_4n_ivan) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size =
           4, color = "black") +
  # Hillsborough (Previously at y = 2.9, now at 4.9)
  annotate("text", x = -170, y = 4.9, label = paste0("pVaR=", round((cdf_value_3n_ivan) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Collier (Previously at y = 1.9, now at 5.9)
  annotate("text", x = -170, y = 5.9, label = paste0("pVaR=", round((cdf_value_2n_ivan) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Charlotte (Previously at y = 0.9, now at 6.9)
  annotate("text", x = -170, y = 6.9, label = paste0("pVaR=", round((cdf_value_1n_ivan) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black")
...
f1_50_irma <- 
  ...
  # Pinellas (Previously at y = 6.9, now at 0.9)
  annotate("text", x = -170, y = 0.9, label = paste0("pVaR=", round((cdf_value_7n_irma) * 100, 0), "%"),
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Miami (Previously at y = 5.9, now at 1.9)
  annotate("text", x = -170, y = 1.9, label = paste0("pVaR=", round((cdf_value_6n_irma) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Manatee (Previously at y = 4.9, now at 2.9)
  annotate("text", x = -170, y = 2.9, label = paste0("pVaR=", round((cdf_value_5n_irma) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Lee (Previously at y = 3.9, now at 3.9)
  annotate("text", x = -170, y = 3.9, label = paste0("pVaR=", round((cdf_value_4n_irma) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size =
           4, color = "black") +
  # Hillsborough (Previously at y = 2.9, now at 4.9)
  annotate("text", x = -170, y = 4.9, label = paste0("pVaR=", round((cdf_value_3n_irma) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Collier (Previously at y = 1.9, now at 5.9)
  annotate("text", x = -170, y = 5.9, label = paste0("pVaR=", round((cdf_value_2n_irma) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") +
  # Charlotte (Previously at y = 0.9, now at 6.9)
  annotate("text", x = -170, y = 6.9, label = paste0("pVaR=", round((cdf_value_1n_irma) * 100, 0), "%"), 
           vjust = 1, hjust = 0, size = 4, color = "black") 
